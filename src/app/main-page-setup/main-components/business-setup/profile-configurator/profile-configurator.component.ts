...
@Component({
  ...
  templateUrl: './profile-configurator.component.html',
  styleUrl: './profile-configurator.component.css'
})
export class ProfileConfiguratorComponent {
  ...
  cars: any[] = [];
  constructor(private service:MainServiceService, private _formBuilder: FormBuilder, breakpointObserver: BreakpointObserver) {
    this.listData = [];
    this.GetBusiness();
...
this.ShowNewBusinessField = false
  ...
  SubmitBusiness(){
    // this.busienssLabel = this.BusinessForm.value.business;
     ...
     if(this.businessObj.profileFields){
      this.listData = this.businessObj.profileFields;
      console.log("Profile ibj",this.businessObj);
     }

     this.service.GetProfileFormlyForm(this.businessObj.businessId).subscribe((val:any)=>{
...
profileFields:CompletefollowupFields
}
...
////////////////////Post Formly obj/////////////////
const CompleteBusinessObj =  this.CompleteBusiness.profileFields;
...
updatedAt:this.CurrentDate,
 ...
 this.service.PostProfileFormlyForm(FormlyFinalObj).subscribe((res:any)=>{
